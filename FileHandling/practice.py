...
def write_file():
    with open("/home/sanjukta/pythonTraining//home/sanjukta/pythonTraining//home/sanjukta/pythonTraining/FileHandling/student.txt", "w") as f:
...
def read_file():
    if os.path.exists("/home/sanjukta/pythonTraining//home/sanjukta/pythonTraining/FileHandling/student.txt"):
        with open("/home/sanjukta/pythonTraining/FileHandling/student.txt", "r") as f:
            print("\n File Content:")
            print(f.read())
    else:
...
def rename_file():
    if os.path.exists("/home/sanjukta/pythonTraining//home/sanjukta/pythonTraining/FileHandling/student.txt"):
        os.rename("/home/sanjukta/pythonTraining//home/sanjukta/pythonTraining/FileHandling/student.txt", "FileHandling/student_records.txt")
